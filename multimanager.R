#' MultipleTool Manager
#' 
#' This function is a tool which facilitates quick renaming of vignettes with multiple organisms
#' It will select all multiple-object vignettes then request user input for the names of the new file
#' For each ID entered, it will create a new line
#' 
...
multiManager = function(path, morphoInclude = T, openImage = T, imagePath = NULL){
